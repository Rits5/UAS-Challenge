...
int main() {
	...
	lineCircleIntersection(0, 10, 30, 10, 12, 0, 10);  // Line: (0,10), (30,10); Circle: (12, 0) r = 10

	lineCircleIntersection(0, -10, 15, 15, 9, 3, 5);   // Line: (0,-10), (15,15); Circle: (9, 3) r = 5

	lineCircleIntersection(0, -10, 15, 15, 10, -5, 4); // Line: (0,-10), (15,15); Circle: (10, -5) r = 4
